...
def plot_threshold_tuning(
    ...
    ax.set_title("Precision vs Recall", fontweight="bold", fontsize=title_fontsize)
    ...
    ax.set_title("F1 Score vs Threshold", fontweight="bold", fontsize=title_fontsize)
    if "f1_equiv" in validation_df.columns:
        ax.legend(fontsize=legend_fontsize)
    ax.tick_params(axis="both", which="major", labelsize=tick_fontsize)
    ax.grid(True, alpha=0.3)
    ...
    ax.set_title("Metrics vs Threshold", fontweight="bold", fontsize=title_fontsize)
    ax.legend(fontsize=legend_fontsize)
    ax.tick_params(axis="both", which="major", labelsize=tick_fontsize)
    ax.grid(True, alpha=0.3)
